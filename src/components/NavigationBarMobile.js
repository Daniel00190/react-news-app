      ...
      <div class="navBar">
         ...
         {menu ? (
            <div class="links_container_mobile">
               ...
               <div class="links">
                  <div
                     class="topics_title title_mobile"
                  ...
                  {topics ? (
                     <div class="topics_dropdown_mobile">
               ...
               <div class="links">
                  <div
                     class="sources_title title_mobile"
                  ...
                  {sources ? (
                     <div class="sources_dropdown_mobile">
                        <Link to="/sources/cnn">
                           <p>CNN</p>
                        </Link>
               ...
               <div class="links">
                  ...
                  {languages ? (
                     <div class="languages_dropdown_mobile">
                        <Link to="/">
                           <p>English</p>
                        </Link>
